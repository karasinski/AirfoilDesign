...
alpha = 0.1000;       % Angle of attack (in radians)
...
ND = 400;             % Number of cells in the downstream direction
NT = 300;             % Number of cells the transverse direction
NW = 1;               % Number of cells in the y-direction (along the foil axis)

% Expansion rates
ExpT = 100            % Expansion rate in transverse direction
ExpD = 100;           % Expansion rate in the downstream direction
ExpArc = 100;         % Expansion rate along the inlet arc
